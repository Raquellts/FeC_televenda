  ...
  return (
    <div>
      <div
        ...
        } loader h-screen w-full flex flex-col justify-center items-center text-center`}
      >
        <svg
        ...
        {timer === true ? (
          <div className="pt-8 fade-in-bottom">
            <p
              className={
            ...
            <a href="/">
              <ButtonPrimary buttonContent="Retornar" theme={theme} />
            </a>
          </div>
        ) : null}
      </div>
